...
<center>
<body>
	<h3>CUADRO ESTADISTICO DE CANTIDAD DE PLATOS OFERTADOS POR PROVEEDORES</h3>
  <div id="canvas-holder" style="width:50%">
		<canvas id="chart-area"></canvas>
	</div>

<?php require('config.php');
$query="select proveedores(suppliername)  as c,suppliername from supplier order by c desc limit 5 ; ";
$result=mysqli_query($db_link, $query);
$clie="";
$platos="";
?>
<table class='centrado' border="1"><tr><td colspan="2" bgcolor="#78AB46">LEYENDA</td></tr>
<tr bgcolor="#40BA4D"><td>PROVEEDORES</td><td>CANTIDAD DE PLATOS OFERTADOS</td></tr>

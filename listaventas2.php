...
<table width="80%" border="0"  cellpadding="0" cellspacing="0"  align="center" >
      ...
      <tr>
        ...
        <form action="listaventas2.php" method="get" ecntype="multipart/data-form">
<input type="hidden" name="id" value="<?php echo $id; ?>" />
        <input type="date" name="query" value="<?php echo date("Y-m-d");?>"style="border:1px solid #CCC; color: #333; width:210px; height:30px;" placeholder="Buscar Ventas por fecha..." /><input type="submit" id="btnsearch" value="Buscar" name="search" /><a href="listaventas2.php?id=<?php echo $id ?>"><input type="button" id="btnsearch" value="Quitar filtro" name="search" /></a>
        </form>
      </td>
      </tr>

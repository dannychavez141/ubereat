...
$stotal=$row['retail']*$cant;
  ?>
      ...
      <tr align="center" style="height:35px">
        ...
        <a href="quitar2.php?idplato=<?php echo $i;?>&&id=<?php echo $id;?>"><input type="button" value="Quitar" style="width:90px; height:30px; color:#FFF; background: #930; border:1px solid #930; border-radius:3px;"></a>
 ...
 $suma=$suma+$stotal;
      ...
      <tr align="center" style="height:35px">
        ...
        <td colspan="3" style="border-bottom:1px solid #333;"><a href="sales2.php?id=<?php echo $id;?>"><input type="button" value="Atras" style="width:90px; height:30px; color:#FFF; background: #930; border:1px solid #930; border-radius:3px;"></a></td>
        <td colspan="3" style="border-bottom:1px solid #333;"><a href="vender2.php?id=<?php echo $id;?>"><input type="button" value="Hacer Pedido" style="width:90px; height:30px; color:#FFF; background: #40ADBA; border:1px solid #40ADBA; border-radius:3px;"></a></td>
      </tr>
<?php } else{?>
  <tr align="center" style="height:35px">
        <td colspan="6" style="border-bottom:1px solid #333;">NO HAY PLATOS EN LA LISTA <a href="sales2.php?id=<?php echo $id;?>"><input type="button" value="VOLVER" style="width:90px; height:30px; color:#FFF; background: #40ADBA; border:1px solid #40ADBA; border-radius:3px;"></a></td>

...
<table width="80%" border="0"  cellpadding="0" cellspacing="0"  align="center" >
      ...
      <tr>
        ...
        <form action="sales2.php" method="get" ecntype="multipart/data-form">
<input type="hidden" name="id" value="<?php echo $id; ?>" />
        <input type="text" name="query" style="border:1px solid #CCC; color: #333; width:210px; height:30px;" placeholder="Buscar Platillos..." /><input type="submit" id="btnsearch" value="Buscar" name="search" /> <a href="carrito2.php?id=<?php echo $id;?>"><input type="button" id="btnsearch" value="Ver carrito" name="search" /></a>
        </form>
      </td>
      </tr>
...
if(isset($_GET['search'])){
            ...
            if($result->num_rows > 0){
              while($row = $result->fetch_array()){?>
                <form action="agregar2.php" method="post" ecntype="multipart/data-form">
